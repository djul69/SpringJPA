package com.wildcodeschool.fr.springandJPAandHibernate.utils;
...
//        User tempUser = userDao.findById(5L).get(); /* On écrit "2L" car
...
//        userDao.deleteById(5L); /* risque de provoquer une erreur si
